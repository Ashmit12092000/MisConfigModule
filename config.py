...
UPLOAD_WINDOW_END_DAY = 28    # Upload window closes on 25th of month

# Notification Scheduler Configuration
UPLOAD_WINDOW_REMINDER_DAY = 28  # Send final reminder on 25th (same as end day)
UPLOAD_LOCK_DAY = 29          # Lock upload window on 26th (day after end date)
SUPERVISOR_APPROVAL_START_DAY = 30  # Supervisor approval window opens on 18th
